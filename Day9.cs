	...
	public IEnumerable<long> Output(){
		while (_executing){
			...
			switch(op) {
				...
				case 3: {
					Memory[getArgAddr(0)] = Input.Dequeue();
				} break;
				case 4: {
					var output = Memory[getArgAddr(0)];
					yield return output;
				} break;
				case 5: {
					var a = Memory[getArgAddr(0)];
